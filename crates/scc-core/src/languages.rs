...
pub const LANGUAGE_REGISTRY: &[LanguageCapability] = &[
    ...
    cap("markdown", "Markdown", LanguageTier::DataConfig, &["md", "mdx", "rst"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "docs; mention index not yet extracted"),
    ...
    cap("c", "C", LanguageTier::IndexSearch, &["c", "h"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
    cap("cpp", "C++", LanguageTier::IndexSearch, &["cc", "cpp", "cxx", "hpp", "hh"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
    cap("objc", "Objective-C", LanguageTier::IndexSearch, &["m", "mm"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
    cap("csharp", "C#", LanguageTier::IndexSearch, &["cs"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
    cap("ruby", "Ruby", LanguageTier::IndexSearch, &["rb"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
    cap("php", "PHP", LanguageTier::IndexSearch, &["php"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
    cap("lua", "Lua", LanguageTier::IndexSearch, &["lua"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
    cap("swift", "Swift", LanguageTier::IndexSearch, &["swift"], &[], false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "not classified by scan yet"),
